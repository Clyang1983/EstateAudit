...
import org.apache.poi.xssf.usermodel.XSSFCellStyle;
	...
	public class ExcelReadAndWrite { 
		...
		class MyXSSFSheetHandler extends DefaultHandler {
				...
				if ("v".equals(name)) {
					...
					case NUMBER:
						...
						if (HSSFDateUtil.isADateFormat(this.formatIndex, n)) {
							Double d = Double.parseDouble(n);
							Date date=HSSFDateUtil.getJavaDate(d);
							thisStr=formateTimeToString(date);
			...
			private String formateTimeToString(Date date) {
		 ...
		 */
		public ExcelReadAndWrite(OPCPackage pkg, PrintStream output,
		...
		public static List<String[]> readerExcel(String path, String sheetName,
			...
			ExcelReadAndWrite xlsx2csv = new ExcelReadAndWrite(p, System.out,
		...
		public static void main(String[] args) throws Exception {
			List<String[]> list = ExcelReadAndWrite
					.readerExcel(
							"F:\\workspace\\EstateAudit\\files\\come.xlsx",
							"明源来电来访", 100);
